...
import { GameData, DEFAULT_GRID_COL_AMOUNT, DEFAULT_GRID_ROW_AMOUNT, DEFAULT_SPEED, LOCAL_STORAGE_KEY } from './types/types';
...
function Game() {
    ...
    const [gameData, setGameData] = useState<GameData>({
        snake: _snake,
        target: getRandomRowAndColumn(_snake, DEFAULT_GRID_ROW_AMOUNT, DEFAULT_GRID_COL_AMOUNT),
        direction: 'RIGHT',
        score: 0,
        started: false,
